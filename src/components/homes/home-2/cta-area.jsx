...
const CtaArea = () => {
  return (
    <>
      <section
        className="tp-cta-2-area p-relative pt-200 pb-90"
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="tp-cta-2-content text-center">
                ...
                <div className="tp-cta-2-content-inner">
                  ...
                  <a href="mailto:teqsify.it@gmail.com">teqsify.it@gmail.com</a>
                </div>
              </div>
            </div>
            <div className="col-xl-6 col-lg-6">
              <div className="tp-cta-2-title-wrapper">
                ...
                <h3 className="tp-section-title">
                  We’re Ready to enhance{" "}
                  <span className="title-color">Your Professional</span>Growth
                </h3>
