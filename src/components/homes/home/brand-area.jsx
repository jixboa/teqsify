...
import brand_img_1 from "@assets/img/brand/home-2/linux.png";
import brand_img_2 from "@assets/img/brand/home-2/ansible.png";
import brand_img_3 from "@assets/img/brand/home-2/docker.png";
import brand_img_4 from "@assets/img/brand/home-2/web.png";
import brand_img_5 from "@assets/img/brand/home-2/devops.png";
    ...
    <>
      <div className="tp-brand-2-area p-relative pt-120 pb-80">
        <div
          ...
          style={{
            backgroundImage: `url(/assets/img/brand/home-2/shape-bg.png)`,
          }}></div>
          ...
          <div className="row justify-content-center pt-80">
            <div className="col-lg-8">
              <div className="tp-brand-2-trend text-center">
                <p>
                  <i className="fa-regular fa-arrow-right-long"></i> IMPROVE AND
                  INNOVATE WITH
                  <Link href="#"> TEQSIFY</Link>
