...
import feature_img_1 from "@assets/img/feature/home-2/img-2_.jpg";
import feature_img_2 from "@assets/img/feature/home-2/img-1.jpg";
import feature_img_3 from "@assets/img/feature/home-2/img-3_.jpg";
          ...
          <div className="row gx-0">
            <div className="col-lg-12">
              <Splide
                options={setting}
                ref={splideRef}
                className="tp-feature-active-2 pt-35 splide wow fadeInUp"
                    ...
                    <div className="tp-feature-thumb-2 w-img p-relative">
                      ...
                      <div className="tp-feature-2-info d-flex align-items-center p-relative">
                        <div className="tp-feature-2-title-wrapper">
                          <span className="tp-feature-2-title-sub">
                            {item.subtitle}
                          </span>
