            ...
            <div className="row align-items-center">
              <div className="col-xl-6">
                <div className="tp-header-2-top-info">
                  <p>
                    <i className="fa-solid fa-clock"></i> Open Hours (Mon - Sun:{" "}
                    <span>8:00</span> am - <span>8:00</span> pm)
                  </p>
                </div>
              </div>
              <div className="col-xl-6">
                <div className="tp-header-2-top-right d-flex justify-content-end align-items-center">
                  <div className="header-date">
                    <p>
                      <i className="fa-sharp fa-solid fa-envelope-dot"></i>{" "}
                  ...
                  {/* <div className="header-location">
                    <Link
                      target="_blank"
                      href="https://www.google.com/maps/place/Taco+Bell/@33.9694034,-112.7228178,17z/data=!3m1!4b1!4m6!3m5!1s0x80d34e9ca49e9761:0x8b141f1593605d2a!8m2!3d33.9694034!4d-112.7206291!16s%2Fg%2F1tdwkssz">
                      <i className="fa-sharp fa-solid fa-location-dot"></i>{" "}
                      teqsify.it@gmail.com
                    </Link>
                  </div> */}
                  <div className="header-social d-xxl-block d-none">
                    <a href="https://web.facebook.com/teqsify" target="_blank">
                      <i className="fa-brands fa-facebook-f"></i>
                    </a>
                    <a href="https://github.com/teqsify" target="_blank">
                      <i className="fa-brands fa-github"></i>
                    </a>
                    <a
                      href="https://www.instagram.com/teqsify/"
                      target="_blank">
                      <i className="fa-brands fa-instagram"></i>
                    </a>
                    <a
                      href="https://www.youtube.com/channel/UCncf1kXqyQAZDSo6tEsN3Tg"
                      target="_blank">
                ...
                <div className="col-xxl-4 col-xl-3 col-lg-2 col-md-6">
                  <div className="tp-header-2-right d-none d-xxl-block">
                    <div className="tp-header-2-main-right d-flex align-items-center justify-content-xxl-end">
                      ...
                      {/*  <div
                        className="tp-header-search search-open-btn d-none d-xxl-block"
