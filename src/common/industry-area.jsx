                ...
                <div className="tp-industry-content">
                  ...
                  <div className="tp-industry-thumb-wrapper d-flex">
                    <div className="tp-industry-thumb text-center">
                      ...
                      <h4 className="tp-industry-title">Linux & DevOps</h4>
                    </div>
                    <div className="tp-industry-thumb text-center">
                    ...
                    <div className="tp-industry-thumb text-center">
                      ...
                      <h4 className="tp-industry-title">Web Development</h4>
                    </div>
                  </div>
                  <div className="tp-industry-btn">
                    ...
                    <Link href="/contact">
                      Get to Interact With Us <span>Click Now</span>
                    </Link>
                  </div>
                </div>
              </div>
                ...
                <div className="tp-industry-tab">
                  ...
                  <div className="tab-content" id="pills-tabContent">
                    <div
                      ...
                      <p>
                        To empower individuals with the knowledge and skills
                        needed for success in the dynamic field of IT. Through
                        our cutting-edge courses and expert consultation
                        services, we aim to foster a community of tech
                        enthusiasts who are well-equipped to innovate and thrive
                        in the ever-evolving digital landscape.
                      </p>

                      <div
                        className="tp-industry-progress-bar fix"
                    ...
                    <div
                      ...
                      <div className="tp-industry-tab-content">
                        ...
                        <p>
                          To be a beacon of excellence in IT education and
                          consultation, inspiring a future generation of tech
                          leaders. We envision a world where individuals, guided
                          by Teqsify, not only master the intricacies of IT but
                          also contribute to groundbreaking innovations that
                          simplify and transform the tech industry.
                        </p>
                        <div
                          className="tp-industry-progress-bar fix"
                          style={{ marginTop: "60px" }}>
                        ...
                        <div className="tp-industry-tab-content-inner d-flex mb-30">
                          ...
                          <ul>
                            <li>
                              ...
                              Provide well-structured and comprehensive courses
                              that meet the evolving demands of the IT industry.
                            </li>
                            <li>
                              <span>
                                <svg
                              ...
                              Guide learners to not only acquire theoretical
                              knowledge but also gain practical, hands-on
                              experience.
                            </li>
                            <li>
                              <span>
                              ...
                              Facilitate a seamless transition from learning to
                              practical application by offering expert IT
                            ...
                            <li>
                              ...
                              Continuously innovate our courses and consultation
                              services to stay ahead of technological
